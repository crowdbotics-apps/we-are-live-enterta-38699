...
## Project Structure
    ...
    ├── we_are_live_enterta_38699  # Django project configurations
...
1. Clone this repo and `cd we_are_live_enterta_38699`
...
2. Clone this repo and `cd we_are_live_enterta_38699`
